            ...
            <div className="w-full h-full flex flex-col py-4 items-center">
                ...
                <div className="flex w-full h-[90%] bg-[#f5f4f3] flex-col items-center py-5">
                    <div className="flex flex-col w-1/2 h-[60%]  gap-3">
                        <p className="text-xl text-start">A confirmartion email has been sent to you.</p>
                        <p className="text-xl text-start">Order number: 120-2354-423245</p>
                        <p className="text-xl text-start">Delivery address: Pl. de la Minoterie 10, 1080 Molenbeek-Saint-Jean </p>
                        <p className="text-xl text-start">Estimated delivery date: {`${day}-${month}-${year}`} </p>
