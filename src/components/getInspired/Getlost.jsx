...
export default function Getlost() {
  return (
    <div className="Getlost w-full h-[25rem] bg-blue-300 flex flex-col justify-end">
        <div className="flex flex-col items-start px-3 py-3 gap-3 w-full h-[7rem] bg-gray-700 bg-opacity-50">
            <h1 className="text-xl text-white">Get lost in these beautiful travel romances</h1>
