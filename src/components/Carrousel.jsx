...
export default function Carrousel() {
  ...
  return (
    <div className="w-full">
      ...
      <div className="carousel carousel-center max-w-full h-[23rem] p-5 space-x-11 bg-[#000000] ">
