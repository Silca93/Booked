...
return (
    <div className='w-vw h-[7rem] flex flex-col justify-center items-center bg-[#f5f4f3] relative'>
        <div className="navbar w-[70%] h-[8%] max-[768px]:h-[4%] bg-[#dedcd6] rounded-md mx-[6rem] flex items-center fixed top-1 z-30 border-[1px] border-black border-opacity-30">
            <div className="Left w-[30%] h-full  rounded-l-full flex items-center">
                ...
                <div className="w-[50%] h-full flex justify-center items-center ">
                    <div onClick={() => {setShow(!show)}} className="w-[85%] h-[55%] cursor-pointer flex border-orange-500 border-[1px] rounded-md max-[1400px]:w-[30%] max-[850px]:rounded-none">
                        <div className="flex justify-center items-center w-[25%] h-full flex-col gap-1 max-[1400px]:w-full">
                            <span className="w-[1.5rem] h-[2px] bg-black max-[1200px]:w-[1rem] max-[768px]:w-[0.8rem] max-[560px]:w-[0.5rem] "></span>
                            <span className="w-[1.5rem] h-[2px] bg-black max-[1200px]:w-[1rem] max-[768px]:w-[0.8rem] max-[560px]:w-[0.5rem]"></span>
                            <span className="w-[1.5rem] h-[2px] bg-black max-[1200px]:w-[1rem] max-[768px]:w-[0.8rem] max-[560px]:w-[0.5rem]"></span>
                        </div>  
            ...
            <div className="Mid w-[40%] h-[2.5rem] ml-[3rem] rounded-md flex max-[1400px]:w-[30%]">
            ...
            <div className="Right w-[30%] h-full  rounded-r-full flex">
                <div className="w-[50%] h-full flex gap-2 justify-end items-center">
                    <label className="cursor-pointer grid place-items-center max-[1200px]:hidden">
                    ...
                    <details className="dropdown flex gap-1 ">
                        ...
                        <summary className="m-1 btn rounded-md min-h-[2rem] h-[2.5rem] max-h-[5rem]    border-black border-[1px] max-[1400px]:w-[4rem] max-[1100px]:w-[3rem] max-[1100px]:h-[2rem]">
                            <div className="flex gap-1 max-[1100px]:flex-col max-[1100px]:items-center">
                                <CgProfile className="pl-2 max-[1100px]:pl-0 max-[1100px]:pt-1 mb-[-2px]" size={16} style={connected? {color:'#F97316'}: ""}  />
                                <span className="max-[1400px]:text-[10px] pr-2  max-[1100px]:text-[8px] max-[1100px]:pr-0 max-[1000px]:mb-3">{connected? name : "Account"}</span>
                            </div>
                        </summary>
                ...
                <Link href="/Shopping">
                <div className="flex gap-3 justify-center items-center w-[5rem] h-[2.5rem] bg-white rounded-md border-black border-[1px] max-[1400px]:w-[3.5rem] max-[1100px]:w-[2.5rem] max-[1100px]:h-[2rem]">
